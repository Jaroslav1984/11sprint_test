...
Файлы в репозитории для использования в автотесте в Pycharm: [data.py](https://github.com/Jaroslav1984/11sprint_test/blob/main/data.py), [configuration.py](https://github.com/Jaroslav1984/11sprint_test/blob/main/configuration.py), sender_stand_request.py
